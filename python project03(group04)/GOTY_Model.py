...
# Evaluate models using the actual sklearn models
# print("\n" + "=" * 60)
# print("Random Forest Strategy Evaluation:")
# print("=" * 60)
# crossValidation(randomF_Strat.get_model(), X_scaled_randomF, Y, kfold)
# multipleTrainTestValidation(randomF_Strat.get_model(), X_scaled_randomF, Y)
# print("\n" + "=" * 60)
# print("Logistic Regression Strategy Evaluation:")
# print("=" * 60)
# crossValidation(logistic_Strat.get_model(), X_scaled_logistic, Y, kfold)
# multipleTrainTestValidation(logistic_Strat.get_model(), X_scaled_logistic, Y)



# # Demo prediction using Strategy Pattern
# print("\n" + "=" * 60)
# print("Strategy Pattern Prediction Demo")
# print("=" * 60)
# test_game = [94.4, 13.6, 328.0]  # Resident Evil 4 features
# rf_prediction = randomF_Strat.predict(test_game)
# lr_prediction = logistic_Strat.predict(test_game)
# print(f"Test Game Features:")
# print(f"  Ratings: {test_game[0]}")
# print(f"  Copies Sold: {test_game[1]} million")
# print(f"  Revenue: ${test_game[2]} million")
# print(f"\nRandom Forest Prediction: {'WINNER 🏆' if rf_prediction == 1 else 'Nominee'}")
# print(f"Logistic Regression Prediction: {'WINNER 🏆' if lr_prediction == 1 else 'Nominee'}")
# print(f"Actual (Resident Evil 4): Winner")
# # Show how to switch strategies easily
# print("\n" + "=" * 60)
# print("Strategy Switching Example")
# print("=" * 60)
# current_strategy = randomF_Strat  # Start with Random Forest
# print(f"Current strategy: Random Forest")
# sample_features = [90.0, 5.0, 200.0]
# prediction = current_strategy.predict(sample_features)
# print(f"Prediction for sample game: {'Winner' if prediction == 1 else 'Nominee'}")
# # Switch to Logistic Regression
# current_strategy = logistic_Strat
# print(f"\nSwitched strategy to: Logistic Regression")
# prediction = current_strategy.predict(sample_features)
# print(f"Prediction for same game: {'Winner' if prediction == 1 else 'Nominee'}")